...
// NEW Add a matched property to set to true once they have been matched!
const cardImages = [
...
export default function Grid(props) {
  ...
  //1) Create our shuffle function to double our array, shuffle it, and then store it in State
  const shuffleCards = () => {
